...
# First: directories
for i in .vim/after .vim/snippets .vim/bundle/nerdcommenter .vim/doc .vim/bundle/SimpylFold .vim/bundle/vim-watchdog .vim/bundle/vim-airline .vim/bundle/supertab .vim/ftplugin .vim/plugin; do
