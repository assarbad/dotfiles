...
# First: directories
for i in .vim/after .vim/snippets .vim/bundle/nerdcommenter .vim/doc .vim/bundle/SimpylFold .vim/bundle/vim-watchdog .vim/bundle/vim-airline .vim/bundle/supertab .vim/bundle/vim-togglemouse .vim/bundle/vim-nerdtree-tabs .vim/bundle/colorscheme-molokai .vim/bundle/colorscheme-solarized .vim/ftplugin .vim/plugin; do
